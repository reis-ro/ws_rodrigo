...
: ${AMENT_CURRENT_PREFIX:="/home/gmsie/main_ws/src/nav2_slam/install/nav2_slam"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_slam/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_slam/environment/path.sh"
