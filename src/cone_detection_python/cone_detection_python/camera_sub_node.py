...
class ImageSubscriber(Node):
    ...
    def __init__(self):
        ...
        self.subscription = self.create_subscription(Image, '/carla/ego_vehicle/rgb_front/right/image_raw', self.image_callback, qos_profile=qos_profile_sensor_data)
        ...
        # # self.yolov7 = Yolov7("/home/gmsie/Documentos/Workspaces/ws_rodrigo/src/cone_detection_python/params/cone_weights.pt", 0.6, 0.5, 1280, None)
        # self.yolov7 = Yolov7("/home/quark/Documents/yolov7/400_epochs_tiny.pt", 0.6, 0.5, 1280, None)
        self.yolov7 = Yolov7("/home/gmsie/Documentos/Workspaces/ws_rodrigo/src/cone_detection_python/params/400_epochs_tiny.pt", 0.75, 0.5, 1280, None)
